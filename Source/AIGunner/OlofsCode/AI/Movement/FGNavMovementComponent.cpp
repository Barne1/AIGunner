...
void UFGNavMovementComponent::BeginPlay()
{
	Super::BeginPlay();
...
void UFGNavMovementComponent::IncreaseMovementSpeed(float Multiplier)
{
	MovementSpeed *= Multiplier;
}

void UFGNavMovementComponent::ResetMovementSpeed()
{
